...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00331();
    ...
    private static final Interpolator sInterpolator = new C00342();
    ...
    private final Runnable mEndScrollRunnable = new C00353();
    ...
    static class C00331 implements Comparator<ItemInfo> {
        C00331() {
        }
    ...
    static class C00342 implements Interpolator {
        C00342() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00851());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C00851 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00851() {
            }
