...
public class FragmentActivity extends Activity {
    ...
    final FragmentContainer mContainer = new C00792();
    boolean mCreated;
    ...
    class C00792 implements FragmentContainer {
        C00792() {
        }
    ...
    public boolean onPreparePanel(int featureId, View view, Menu menu) {
        ...
        return super.onPreparePanel(featureId, view, menu) | this.mFragments.dispatchPrepareOptionsMenu(menu);
    }
