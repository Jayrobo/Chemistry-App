...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C00451();
        boolean isOpen;

        static class C00451 implements Creator<SavedState> {
            C00451() {
            }
                    ...
                    if (child.getVisibility() != 8) {
                        ...
                        if (!canSlide || child == this.mSlideableView) {
                            if (lp.weight > 0.0f) {
                                ...
                                if (canSlide) {
                                    int newWidth = widthSize - (lp.leftMargin + lp.rightMargin);
